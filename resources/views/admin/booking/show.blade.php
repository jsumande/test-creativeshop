...
<div class="row">
    <div class="col-sm-4 border-right"> <strong>@lang('app.booking') @lang('app.date')</strong> <br>
        <p class="text-primary"><i class="icon-calendar"></i> {{ $booking->date_time->format('d F Y') }}</p>
    </div>
    <div class="col-sm-4 border-right"> <strong>@lang('app.booking') @lang('app.time')</strong> <br>
        <p class="text-primary"><i class="icon-alarm-clock"></i> {{ $booking->date_time->format('h:i A') }} </p>
    </div>
...
<div class="row">
    <div class="col-sm-4"><strong>Business </strong> <br>
        @foreach($businessess as $business)
            @if($business->id == $booking->business_id)
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-condensed">
                    ...
                    @if ($booking->payment_status == 'pending' && !$user->is_admin)
                    <tr>
                        <td colspan="2">
                            <div class="payment-type">
                                ...
                                <div class="payments">
                                    ...
                                    <a href="javascript:;" id="stripePaymentButton" data-bookingId="{{ $booking->id }}" class="btn btn-custom btn-blue"><i class="fa fa-cc-stripe mr-2"></i>@lang('front.buttons.stripe')</a>
                                    @endif
                                    @if($credentials->paypal_status == 'active')
                                    <a href="{{ route('front.paypal', $booking->id) }}" class="btn btn-custom btn-blue"><i class="fa fa-paypal mr-2"></i>@lang('front.buttons.paypal')</a>
                                    @endif
                                    @if($credentials->offline_payment == 1)
                                    <a href="{{ route('front.offline-payment', $booking->id) }}" class="btn btn-custom btn-blue"><i class="fa fa-money mr-2"></i>@lang('app.offline')</a>
                                    @endif
                                </div>
                            </div>
                        </td>
