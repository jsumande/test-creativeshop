        ...
        <div class="card">
          <div class="card-header d-flex p-0">
            ...
            {{-- <ul class="nav nav-pills ml-auto p-2">
              <li class="nav-item"><a class="nav-link active" href="{{ route('admin.reports.index') }}">@lang('menu.earningReport')</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('admin.reports.customer') }}" >@lang("menu.customerReport")</a></li>
              <li class="nav-item"><a class="nav-link" href="#tab_3" >Tab 3</a></li>
            </ul> --}}
          </div>
          <!-- /.card-header -->
          <div class="card-body">
