            ...
            <div class="card">
                <div class="card-body">
                    {{-- <div class="d-flex justify-content-center justify-content-md-end mb-3">
                        <a href="{{ route('super.subscription.create') }}" class="btn btn-rounded btn-primary mb-1"><i class="fa fa-plus"></i> @lang('app.createNew')</a>
                    </div> --}}
    ...
    <script>
        $(document).ready(function() {
            var table = $('#myTable').dataTable({
                ...
                // processing: true,
                serverSide: true,
                ajax: '{!! route('super.subscription.index') !!}',
                language: {
